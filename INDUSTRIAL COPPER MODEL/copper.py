...
with tab1:  
     # Define the possible values or unique values for the dropdown menus
...
st.write( f'<h6 style="color:rgb(0, 153, 153,0.35);">App Created by Geetha Krishnan</h6>', unsafe_allow_html=True )    
